...
//
// Note: You can't iterate(objectEnumerator,enumerateObjectsUsingBlock) and use indexed(objectAtIndex,objectAtIndexedSubscript) access same time - result unpredictable.
//
